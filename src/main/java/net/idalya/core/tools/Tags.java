...
public class Tags {
    ...
    public Tags(String name, String prefix, String suffix, Scoreboard current) throws Exception {
        this.prefix = prefix;
        this.suffix = suffix;
    ...
    public Tags(String name, String prefix, String suffix) throws Exception {
    ...
    public static void setNameTag(Player player, String name, String prefix, String suffix){
        try{
            Tags tagplayer = new Tags(name, prefix, suffix);
